...
public class RewardVideoSample extends ToolBarActivity {
    ...
    AtmosplayRewardVideo mRewardVideo;
    UserConfig mConfig;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRewardVideo = AtmosplayRewardVideo.init(this, mConfig.getVideoAppId());
    ...
    public void request() {
        ...
        mRewardVideo.loadAd(unitId, new AtmosplayAdLoadListener() {
    ...
    public void present() {
        final String unitId = mUnitIdEdit.getText().toString().trim();
        mRewardVideo.show(unitId, new AtmosplayAdListener() {
            @Override
    ...
    public void appIdChanged(CharSequence s, int start, int before, int count) {
        if (TextUtils.isEmpty(s.toString().trim())) {
            ...
            AtmosplayRewardVideo.init(this, s.toString().trim());
    ...
    private void loadPreviewerAd(final String srcId, JSONObject data) {
        mRewardVideo.previewerAtmosplayAds(data, new AtmosplayAdLoadListener() {
            @Override
            public void onLoadFinished() {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        mRewardVideo.show(tag, new AtmosplayAdListener() {
                            @Override
                            public void onVideoStart() {
