...
import com.atmosplayads.demo.util.Encrypter;
...
public class InterstitialSample extends ToolBarActivity {
    ...
    AtmosplayInterstitial mInterstitial;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInterstitial = AtmosplayInterstitial.init(this, mConfig.getInterstitialAppId());
    ...
    protected void onResume() {
        ...
        mInterstitial.setAutoLoadAd(mConfig.isInterstitialAutoload());
    }
    ...
    public void request() {
        ...
        mInterstitial.loadAd(unitId, new AtmosplayAdLoadListener() {
    ...
    public void present() {
        final String unitId = mUnitIdEdit.getText().toString().trim();
        mInterstitial.show(unitId, new AtmosplayAdListener() {
            @Override
    ...
    public void appIdChanged(CharSequence s, int start, int before, int count) {
        if (TextUtils.isEmpty(s.toString().trim())) {
            ...
            AtmosplayInterstitial.init(this, s.toString().trim());
    ...
    private void loadPreviewerAd(final String srcId, JSONObject data) {
        mInterstitial.previewerAtmosplayAds(data, new AtmosplayAdLoadListener() {
            @Override
            public void onLoadFinished() {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        mInterstitial.show(tag, new AtmosplayAdListener() {
                            @Override
                            public void onVideoStart() {
