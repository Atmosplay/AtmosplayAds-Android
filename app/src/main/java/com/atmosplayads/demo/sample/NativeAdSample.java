...
import com.atmosplayads.AtmosplayNativeAd;
...
import com.atmosplayads.nativead.NativeAdRender;
import com.atmosplayads.nativead.NativeEventListener;
import com.atmosplayads.nativead.ViewBinder;
...
public class NativeAdSample extends ToolBarActivity {
    ...
    private AtmosplayNativeAd mAtmosplayNativeAd;
    ...
    private void initNativeAd(String appId, String unitId) {
        mAtmosplayNativeAd = new AtmosplayNativeAd(this, appId, unitId);
        mAtmosplayNativeAd.setChannelId(UserConfig.getInstance(this).getChannelId());
        mAtmosplayNativeAd.setAdRender(mNativeAdRender);
